...
<div class="peach-card">
	<div>
		...
		<div class="flex items-center justify-center light-card">
	...
	<div class="grid grid-cols-3">
		...
		<div>
			<div>Top Frameworks and Technologies</div>
			<img
